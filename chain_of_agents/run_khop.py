...
def main():
    ...
    parser.add_argument("--min_hops", type=int, default=4, help="Minimum number of hops")
    parser.add_argument("--max_hops", type=int, default=4, help="Maximum number of hops") 
    parser.add_argument("--num_facts", type=int, default=50, help="Number of facts to include in each problem")
    parser.add_argument("--facts_per_worker", type=int, default=10, help="Number of facts per worker (for IterativeQueryAgents)")
